...
$organ=$_POST['organ'];
$status=1;
$sql="INSERT INTO  organdonor(FullName,MobileNumber,organ,EmailId,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:mobile,:organ,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<select name="gender" class="form-control" required>
<option value="">Select</option>
<option value="Kidny">Kidney</option>
